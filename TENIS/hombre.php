...
$db = new Database();
$con = $db->conectar();
$sql= $con->prepare("SELECT id,Imagen,nombre,precio from mis_productos WHERE id_categoria=1 and activo=1");
$sql->execute();
...
<header class="header">
		<div class="container">
			...
			<nav class="menu">
				...
				<b><a href="" class="nav-link active">Hombre</a></b>
...
<center>
<h3 style="color:white">Tenis de Hombre</h3></center>
  <main>
