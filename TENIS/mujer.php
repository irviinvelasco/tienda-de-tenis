...
$sql= $con->prepare("SELECT id,Imagen,nombre,precio from mis_productos WHERE id_categoria=2 and activo=1");
$sql->execute();
...
<center>
<h3 style="color:white">Tenis de Mujer</h3></center>
  <main>
